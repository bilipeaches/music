        ...
        if(type.replace(/\s+/g,"") != ""){
            try{
                ...
                if(type == "网易云音乐"){
                    ...
                    var strVar = "<div class=\"mdui-card mdui-text-color-theme\"><div class=\"mdui-card-media\"><img src=\"{0}\" class='img{3}' id='{2}'><div class=\"mdui-card-media-covered\"><div class=\"mdui-card-primary\"><div class=\"mdui-card-primary-title\">{1}<\/div><div class=\"mdui-card-primary-subtitle {3}\">{2}<\/div><\/div><\/div><\/div><div class=\"mdui-card-actions\"><button class=\"mdui-btn mdui-ripple\" onclick=\"download('http://music.163.com/song/media/outer/url?id={2}.mp3')\"><i class=\"mdui-icon material-icons\">file_download<\/i>下载<\/button> <button class=\"mdui-btn mdui-ripple\" onclick=\"listen('{2}', '{1}')\"><i class=\"mdui-icon material-icons\">play_circle_outline<\/i>试听<\/button><\/div><\/div>\n";
